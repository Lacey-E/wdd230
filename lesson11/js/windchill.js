const apiURL = 'https://api.openweathermap.org/data/2.5/weather?id=560791&units=imperial&APPID=b4632dbb5d0b503e5f8c44170654d4ef';
fetch(apiURL)
...
const forecastURL = 'https://api.openweathermap.org/data/2.5/forecast?id=560791&units=imperial&APPID=b4632dbb5d0b503e5f8c44170654d4ef';
fetch(forecastURL)
    .then((response) => response.json())
    .then((forecast) => {
